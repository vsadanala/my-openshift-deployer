...
/*		openshift.withCluster() { // Use "default" cluster or fallback to OpenShift cluster detection
	...
	oc set image deployment ${params.SERVICE} ${params.SERVICE}=image-registry.openshift-image-registry.svc:5000/development/${params.SERVICE}:${params.DEST_IMAGE_TAG}
